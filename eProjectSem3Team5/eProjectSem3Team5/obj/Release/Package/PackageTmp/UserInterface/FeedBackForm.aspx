    ...
    <form id="feedBackForm" runat="server" >
        <table width="400px" class="freecontactform">
            ...
            <tr>
                ...
                <td valign="top">
                    <input type="text" name="Telephone_Number" id="txtCompanyName" runat="server" maxlength="100" style="width: 230px" />
                </td>
            </tr>
            <tr>
                <td valign="top" style="width: 111px">
            ...
            <tr>
                ...
                <td valign="top">
                    <input type="text" name="Telephone_Number" id="txtPostalCode" runat="server" maxlength="100" style="width: 230px" />
                </td>
            </tr>
             <tr>
                <td valign="top" style="width: 111px">
